...
<div class="container">
	<div class="row" >
		...
		<div class="col-md-7" style="background-color: aliceblue;margin-top:40px;">
			<form action="">
			<h2 style="color:orange;margin-left:20%;">Delete Room</h2><br/>
				<div class="textbox-search">
				<span class="span-search">Enter room:</span>
				<input type="text" name="building"><br/><br/>
				</div>
				<input type="submit" value="DELETE" class="search-btn">
				<a href="room-report.jsp"><input type="button" value="BACK" class="back-btn"></a>
		...
		if(request.getParameter("building")!=null)
			{
				...
				stmt=con1.prepareStatement("delete from room_db where rno=?");
				...
				{%>
					...
					window.location.href='room-report.jsp';
					session.invalidate();
					</script>
				<%}
				else
				{%>
				<script type='text/javascript'>
				alert('Room is not deleted enter valid room name');
				window.location.href='room-report.jsp';
				session.invalidate();
				</script>
					<%}
