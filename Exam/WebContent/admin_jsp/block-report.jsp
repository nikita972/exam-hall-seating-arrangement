	...
	<div class="row" >
		...
		<div class="col-md-4" style="background-color: aliceblue;margin-top:40px;">
			<form action="delete-row.jsp" method="post">
				<h2 style="color:orange;margin-left:15%;">Block reports</h2><br/>
				...
				<center><a href="delete-block.jsp"><input type="button" value="DELETE" style="background-color:red;color:white;"></center>
		</form>
		</div>
		</div>
		</div>
