		...
		<a href="../admin_html/admin-index.jsp">Home</a>
    		...
    		<button class="dropbtn">Reports
   				 ...
   				 <div class="dropdown-content">
	      			...
	      			<a href="contact-us-report.jsp">Contact us reports</a>
	    		</div>
	    	</div>
...
<div class="container">
	<div class="row" >
		...
		<form action="contact-us-report.jsp method="post">
				<h2 style="color:orange;margin-left:15%;">Contact us reports</h2><br/>
				<table class="table-contact-us" border="1">
					<tr>
					<th class="th--contact-us">Student name</th>
					<th>Email id</th>
					...
					<%
						...
						DBCon db1=new DBCon();
						con1=db1.dbCon();
						stmt=con1.prepareStatement("select * from contact_us");
