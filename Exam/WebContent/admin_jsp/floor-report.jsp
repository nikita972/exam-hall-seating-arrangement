...
<div class="container">
	<div class="row" >
		...
		<div class="col-md-4" style="background-color: aliceblue;margin-top:40px;">
		<form action="delete-row.jsp" method="post">
				<h2 style="color:orange;margin-left:15%;">Floor reports</h2><br/>
				<table class="table" border="1">
					...
					<%
						session.setAttribute("delete_floor","Floor");
						int i;
						String db_floor;
						Connection con1;
				...
				<center><a href="delete-floor.jsp"><input type="button" value="DELETE" style="background-color:red;color:white;"></center>
		</form>
