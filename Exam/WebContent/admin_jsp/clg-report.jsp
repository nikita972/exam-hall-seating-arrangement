	...
	<div class="row" >
		...
		<div class="col-md-4" style="background-color: aliceblue;margin-top:40px;">
			<form action="delete-row.jsp" method="post">
				<h2 style="color:orange;margin-left:15%;">Collage reports</h2><br/>
				<table class="table" border="1">
					<tr>
					<th>Collage number</th>
					<th>Collage</th>
					</tr>
					<%
						int i;
				...
				<center><a href="delete-clg.jsp"><input type="button" value="DELETE" style="background-color:red;color:white;"></center>
		</form>
		</div>
		</div>
		</div>
