...
<div class="row" >
 <div class="pull-right">
	<ul class="nav navbar-nav" >
		...
		<li><a href="contact_us_nreg.jsp">Contact Us</a><li>
		<li><a href="loginExeUser.html">Login</a><li>
	</ul>
	</div>
	</div>
</div>
	...
	<div class="row" >
		...
		<div class="col-md-7" style="background-color: aliceblue;margin-top:40px;">
			...
			<div class="text-box1">
			<span>Name:</span>
				<input type="text" name="name" required="" placeholder="Enter full name" pattern="[a-zA-Z ]{6,25}" 
				title="Please Enter Full Name" required onkeypress="return onlyAlphabets(event,this);"><br/><br/>
			</div>
			<div class="text-box1">
			<span>Email id:</span>
				<input type="text" name="email_id" required="" placeholder="example@gmail.com " required="" title="Please Enter valid email id"
				pattern="[a-z0-9._%+-]+@[a-z9-9.-]+\.[a-z]{2,4}$"><br/><br/>
			</div>
			<div class="text-box1">
			<span>Mobile Number:</span>
				<input type="text" name="mob_no" required="" title="10 numeric characters only" required="" onkeypress="return isNumber(event)" 
				maxlength="10" minlength="0"  placeholder="(10 chars) 9845710286" pattern="[0-9]{10,}"><br/><br/>
			</div>
			
				<span>Message:</span>
				<textarea name="msg"  minlength="10" maxlength="10000" required ></textarea>
		...
		<%
			...
			if(name!=null && email_id!=null && mob_no!=null && msg!=null)
			{
				...
				{%>
					...
					window.location.href='contact_us_nreg.jsp';
					</script>
				<%}
